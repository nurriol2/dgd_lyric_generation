...
def main():
    ...
    if flask.request.method=="POST":
        sequence_in = flask.request.form["sequence_in"]
        sequence_in = sequence_in.lower()
        prediction = generate_text(model, sequence_in)
        return flask.render_template("main.html", original_input={"input_sequence":sequence_in}, result=prediction)
